...
def draw_cd_diagram(df_perf=None, alpha=0.83, title=None, labels=False):
    """
...
def wilcoxon_holm(alpha=0.83, df_perf=None):
    """
...
df_perf = pd.read_csv('DisjointResNet.csv',index_col=False)
