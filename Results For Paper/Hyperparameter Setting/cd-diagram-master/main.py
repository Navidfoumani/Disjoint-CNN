...
def draw_cd_diagram(df_perf=None, alpha=0.06, title=None, labels=False):
    """
...
def wilcoxon_holm(alpha=0.06, df_perf=None):
    """
...
df_perf = pd.read_csv('T_S_CNN.csv',index_col=False)
